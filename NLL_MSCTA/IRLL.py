# -*- coding: utf-8 -*-
"""
Created on Sat May 11 21:53:49 2024
...
player_id=np.load("C:/Users/am is are/Desktop/draft_data/INLL_id_anum/INLL_id.npy",allow_pickle=True)
player_a_num=np.load("C:/Users/am is are/Desktop/draft_data/INLL_id_anum/INLL_anum.npy",allow_pickle=True) 
player_sats=np.load("C:/Users/am is are/Desktop/draft_data/INLL_id_anum/players_sats.npy",allow_pickle=True)
#a=1
for i in range(20):
    ...
    for x in range(len(a_player_id)):
        ...
        if len(a_player_id[x])==0: 
            continue
        
        all_players_copy_action = [w['action'].copy() for w in sat_players_set]
        for e in range(len(a_player_id[x])):
            sat_player = sat_players_set[a_player_id[x][e]-1]
            a_num = a_player_a_num[x][e]
...
#np.save("C:/Users/am is are/Desktop/draft_data/ISNLL_random_F50000",F_record)
#plt.savefig('C:/Users/am is are/Desktop/draft_figure/ISNLL_random50000.pdf',dpi=1200,bbox_inches='tight')    
