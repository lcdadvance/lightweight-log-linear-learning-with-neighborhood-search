...
for i in range(20):
    ...
    while True:
        ...
        prob_all_act = get_prob_LL(indiv_uti_all_action, 90) #τ=90
        new_action = get_a_action(prob_all_act, a_player['action_set'])
        a_player['action']=new_action #update action
...
#np.save("C:/Users/am is are/Desktop/draft_data/ALL_F50000",F_record)
#plt.savefig('C:/Users/am is are/Desktop/draft_figure/ALL50000.pdf',dpi=1200,bbox_inches='tight')
